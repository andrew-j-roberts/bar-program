...
public class NoLocalPubSub extends SampleApp implements JCSMPStreamingPublishEventHandler {
	...
	public void run(String[] args) {
		...
		try {
			...
			/**  DEMO MESSAGE DEMOTION  **/
			send(producer1, t, DeliveryMode.PERSISTENT );
			incoming = directConsumer.receive(250);
			System.out.println("MESSAGE DEMOTION, directConsumer received: " + String.valueOf(incoming));
			...
			send(producer2, t, DeliveryMode.DIRECT); // change to persistent
