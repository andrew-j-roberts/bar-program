...
public class SimpleFlowToTopic extends SampleApp implements XMLMessageListener, JCSMPStreamingPublishEventHandler {
    ...
    void createSession(String[] args) throws InvalidPropertiesException {
         ...
         */
        /**  HAVE TO SET TO CLIENT HERE SO THAT ITS NOT AUTO ACKING **/
    ...
    public void run(String[] args) {
        ...
        try {
            ...
            if (useDurable) {
                ...
                topicEndpoint = JCSMPFactory.onlyInstance().createDurableTopicEndpoint(SampleUtils.SAMPLE_TOPICENDPOINT);
                session.provision(topicEndpoint, endpointProp, JCSMPSession.FLAG_IGNORE_ALREADY_EXISTS);
            } else {
            ...
            // Create and start the receiver — SHOULD ONLY BE LAST VALUE ON THE QUEUE.  Not the behavior it shows.
